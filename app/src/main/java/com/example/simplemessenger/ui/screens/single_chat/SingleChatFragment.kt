...
class SingleChatFragment(private val contact: CommonModel) : BaseFragment(R.layout.fragment_single_chat) {
   ...
   private var mCountMessages = 15
    ...
    private lateinit var mBotomSheetBehavior:BottomSheetBehavior<*>
    ...
    private fun initFields() {
        mBotomSheetBehavior = BottomSheetBehavior.from(bottom_sheet_choice)
        mBotomSheetBehavior.state = BottomSheetBehavior.STATE_HIDDEN
    ...
    private fun attach() {
        mBotomSheetBehavior.state = BottomSheetBehavior.STATE_EXPANDED
