...
import com.example.simplemessenger.utilits.AppVoicePlayer
...
class HolderVoiceMessage(view:View):RecyclerView.ViewHolder(view),MessageHolder {
   private val blocReceivedVoiceMessage: ConstraintLayout = view.block_receiver_voice_message
    private  val blocUserVoiceMessage: ConstraintLayout = view.block_user_voice_message
    private  val chatUserVoiceMessageTime: TextView = view.chat_user_voice_message_time
    private val chatReceivedVoiceMessageTIme: TextView = view.chat_receiver_voice_message_time
