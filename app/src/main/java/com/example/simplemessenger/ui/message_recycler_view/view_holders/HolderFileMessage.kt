...
import com.example.simplemessenger.database.getFileFromStorage
import com.example.simplemessenger.ui.message_recycler_view.views.MessageView
import com.example.simplemessenger.utilits.WRITE_FILES
import com.example.simplemessenger.utilits.asTime
import com.example.simplemessenger.utilits.checkPermission
...
class HolderFileMessage(view:View):RecyclerView.ViewHolder(view),MessageHolder {
   ...
   private val blocReceivedFileMessage: ConstraintLayout = view.block_receiver_file_message
    private  val blocUserFileMessage: ConstraintLayout = view.block_user_file_message
    private  val chatUserFileMessageTime: TextView = view.chat_user_file_message_time
    private val chatReceivedFileMessageTIme: TextView = view.chat_receiver_file_message_time
